...
```{r}
##Load in files 
seurat <- readRDS( "Saves/Caden/For_Figures.rds") %>% DietSeurat(counts = TRUE)
...
for(i in 1:length(allcells)){
  ...
  save(resultlist_normative, file = paste0("~/scratch/medial_septum_sct/Caden_Norm_DEG/limmaout_", newcell,".rda"))
}
```
