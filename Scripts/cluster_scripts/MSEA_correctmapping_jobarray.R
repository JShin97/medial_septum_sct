...
##############################################################################
## input files
input_dir <- "Results/complete_analysis/MSEA/DEG_SD/input_files"
#input_files <- list.files(input_dir, full.names = FALSE)
input_files <- c("modfile_logfc_abs0.1.txt")
...
## output_dir 
output_dr <- "Results/compelte_analysis/MSEA/DEG_SD/dist50_jobarray"
##############################################################################
